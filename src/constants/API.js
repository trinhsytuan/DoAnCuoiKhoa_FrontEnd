export const API = {
  ...
  KET_QUA_DO_NHIET_DO_BY_PHIEU_GIAO_VIEC:
    "/api/ketquadonhietdo/phieugiaoviec/{0}",
  KET_QUA_DO_NHIET_DO_BY_DUONG_DAY:
    "/api/ketquadonhietdo/duongday/?duong_day_id={0}",
  REPORT_BIEU_MAU_DO_NHIET_DO:
    "/api/ketquadonhietdo/download/?duong_day_id={0}",
  ...
  REPORT_XACNHANKHOA_PHIEUKIEMTRA_DOCX:
    "/api/report/xacnhankhoaphieukiemtradocx/?id={0}",
  REPORT_XACNHANKHOA_PHIEUKIEMTRA_PDF:
    "/api/report/xacnhankhoaphieukiemtrapdf/?id={0}",
  REPORT_PHIEU_SUACHUA_DOCX:
    "/api/report/phieusuachuabaoduongdocx/?id={0}&type={1}",
  REPORT_PHIEU_SUACHUA_PDF:
    "/api/report/phieusuachuabaoduongpdf/?id={0}&type={1}",
  REPORT_PHIEU_CONG_VIEC_PHU_TRO_DOCX:
    "/api/report/phieucongviecphutrodocx/?id={0}&type={1}",
  REPORT_PHIEU_CONG_VIEC_PHU_TRO_PDF:
    "/api/report/phieucongviecphutropdf/?id={0}&type={1}",
  ...
  REPORT_DANH_SACH_CONG_VIEC_THEO_VI_TRI:
    "/api/report/congviectheovitri/download/{0}",
  ...
  TONTAI_GHINHAN_TAI_THOIDIEM_DONGDIEN_QUERY:
    "/api/tontaithoidiemdongdien?page={0}&limit={1}{2}",
  TONTAI_GHINHAN_TAI_THOIDIEM_DONGDIEN_ID: "/api/tontaithoidiemdongdien/{0}",
  DOWNLOAD_TONTAI_THOIDIEM_DONGDIEN:
    "/api/congtrinhxaydung/tontaithoidiemdongdien/{0}",
  ...
  NOI_DUNG_TON_TAI_THOI_DIEM_BAN_GIAO_QUERY:
    "/api/tontaithoidiembangiao/noidungtontai?page={0}&limit={1}{2}",
  TON_TAI_THOI_DIEM_BAN_GIAO_QUERY:
    "/api/tontaithoidiembangiao?page={0}&limit={1}{2}",
  TON_TAI_THOI_DIEM_BAN_GIAO_ID: "/api/tontaithoidiembangiao/{0}",
  DOWNLOAD_TON_TAI_THOI_DIEM_BAN_GIAO:
    "/api/congtrinhxaydung/tontaithoidiembangiao/?id={0}",

  CONG_TRINH_XU_LY_HET_TON_TAI: "/api/congtrinhxulyhettontai",
  CONG_TRINH_XU_LY_HET_TON_TAI_QUERY:
    "/api/congtrinhxulyhettontai?page={0}&limit={1}{2}",
  CONG_TRINH_XU_LY_HET_TON_TAI_ID: "/api/congtrinhxulyhettontai/{0}",
  DOWNLOAD_CONG_TRINH_XU_LY_HET_TON_TAI:
    "/api/congtrinhxaydung/congtrinhxulyhettontai/?{0}",
  CONG_TRINH_XAY_DUNG_FIND_ONE: "/api/congtrinhxaydung",

  CONG_TRINH_DONG_DIEN_CHUA_BAN_GIAO:
    "/api/congtrinhxaydung/dongdienchuabangiao",
  DOWNLOAD_CONG_TRINH_DONG_DIEN_CHUA_BAN_GIAO:
    "/api/congtrinhxaydung/dongdienchuabangiao/download",

  CONG_TRINH_BAN_GIAO_NHUNG_CHUA_HET_TON_TAI:
    "/api/congtrinhxaydung/bangiaochuahettontai",
  DOWNLOAD_CONG_TRINH_BAN_GIAO_NHUNG_CHUA_HET_TON_TAI:
    "/api/congtrinhxaydung/bangiaochuahettontai/download",
  ...
  CONG_TRINH_DA_XU_LY_HET_TON_TAI:
    "/api/bienbanxacnhandongdien/congtrinhdaxulyhettontai",
  DOWNLOAD_BIEN_BAN_XAC_NHAN_DONG_DIEN:
    "/api/bienbanxacnhandongdien/download/?id={0}",
  ...
  SO_LUONG_COT_DIEN_THEO_HANG:
    "/api/baocaokhiemkhuyetthietbi/cotdientheohang{0}",
  SO_LUONG_COT_DIEN_THEO_DON_VI:
    "/api/baocaokhiemkhuyetthietbi/cotdientheodonvi{0}",

  SO_LUONG_CACH_DIEN_THEO_HANG:
    "/api/baocaokhiemkhuyetthietbi/cachdientheohang{0}",
  SO_LUONG_CACH_DIEN_THEO_DON_VI:
    "/api/baocaokhiemkhuyetthietbi/cachdientheodonvi{0}",

  SO_LUONG_DAY_DAN_THEO_HANG: "/api/baocaokhiemkhuyetthietbi/daydantheohang{0}",
  SO_LUONG_DAY_DAN_THEO_DON_VI:
    "/api/baocaokhiemkhuyetthietbi/daydantheodonvi{0}",

  SO_LUONG_DAY_CHONG_SET_THEO_HANG:
    "/api/baocaokhiemkhuyetthietbi/chongsettheohang{0}",
  SO_LUONG_DAY_CHONG_SET_THEO_DON_VI:
    "/api/baocaokhiemkhuyetthietbi/chongsettheodonvi{0}",

  SO_LUONG_DAY_CAP_QUANG_THEO_HANG:
    "/api/baocaokhiemkhuyetthietbi/capquangtheohang{0}",
  SO_LUONG_DAY_CAP_QUANG_THEO_DON_VI:
    "/api/baocaokhiemkhuyetthietbi/capquangtheodonvi{0}",

  SO_LUONG_THEO_HANG_SAN_XUAT:
    "/api/baocaokhiemkhuyetthietbi/soluongtheohang{0}",
  SO_LUONG_THEO_DON_VI: "/api/baocaokhiemkhuyetthietbi/soluongtheodonvi{0}",

  SO_LUONG_DAY_TIEP_DAT_THEO_HANG:
    "/api/baocaokhiemkhuyetthietbi/tiepdattheohang{0}",
  SO_LUONG_DAY_TIEP_DAT_THEO_DON_VI:
    "/api/baocaokhiemkhuyetthietbi/tiepdattheodonvi{0}",

  SO_LUONG_DAY_GIAO_CHEO_THEO_HANG:
    "/api/baocaokhiemkhuyetthietbi/giaocheotheohang{0}",
  SO_LUONG_DAY_GIAO_CHEO_THEO_DON_VI:
    "/api/baocaokhiemkhuyetthietbi/giaocheotheodonvi{0}",
  ...
  DOWNLOAD_TON_TAI_DONG_DIEN:
    "/api/congtrinhxaydung/tontaidongdien/download?{0}",
  DOWNLOAD_BIEN_BAN_XAC_NHAN:
    "/api/congtrinhxaydung/bienbanxacnhan/download?{0}",
  ...
  CONG_TRINH_BAN_GIAO_DA_HET_TON_TAI:
    "/api/congtrinhxaydung/congtrinhxulyhettontai",
  DOWNLOAD_CONG_TRINH_BAN_GIAO_DA_HET_TON_TAI:
    "/api/congtrinhxaydung/congtrinhxulyhettontai/download",
